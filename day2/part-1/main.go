...
func isPossible(game *Game, limit Content) bool {
	return game.Content.Blues <= limit.Blues &&
		game.Content.Reds <= limit.Reds &&
		game.Content.Greens <= limit.Greens
}
